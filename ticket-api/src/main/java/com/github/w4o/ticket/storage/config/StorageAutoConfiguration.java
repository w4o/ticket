package com.github.w4o.ticket.storage.config;

import com.github.w4o.ticket.service.TicketStorageService;
import com.github.w4o.ticket.storage.*;
...
public class StorageAutoConfiguration {
    ...
    @Autowired
    public StorageAutoConfiguration(StorageProperties properties, TicketStorageService ticketStorageService) {
    ...
    public StorageService storageService() {
        ...
        StorageService storageService = new StorageService(ticketStorageService);
